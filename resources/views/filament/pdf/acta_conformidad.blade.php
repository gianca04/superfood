...
<body>
    ...
    <div class="action-buttons">
        ...
        @else
            <button class="btn-pdf" disabled style="opacity: 0.5; cursor: not-allowed;" title="No disponible en previsualización">
                <span>📄</span> Descargar PDF
            </button>
            <button class="btn-excel" disabled style="opacity: 0.5; cursor: not-allowed;" title="No disponible en previsualización">
                <span>📊</span> Descargar Excel
            </button>
        @endif
        ...
        <table class="header-table">
            <tr>
                <td style="width: 200px;">
                    <img src="{{ asset('images/Logo2.png') }}" alt="Logo2" style="height: 80px;">
                </td>
                ...
                <table class="signatures-table">
                    <tr>
                        ...
                        <td style="width: 50%; padding-right: 20px;">
                            ...
                            <div style="text-align: center; font-size: 10px; font-weight: bold; margin-bottom: 8px;">FIRMA</div>
