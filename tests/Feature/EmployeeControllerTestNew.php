...
class EmployeeControllerTestNew extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_can_filter_employees_by_document_type()
    {
        ...
        $response = $this->getJson('/api/employees?document_type=DNI');
    ...
    public function it_can_search_employees_by_document_number()
    {
        ...
        $response = $this->getJson('/api/employees?search=12345678');
    ...
    public function it_can_get_available_employees_for_project()
    {
        ...
        $response = $this->getJson('/api/employees/available/project?date=2024-01-15');
